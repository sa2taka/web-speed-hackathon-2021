...
const NavigationItem: React.VFC<Props> = ({ href, icon, onClick, text }) => {
  return (
    <li>
      {href !== undefined ? (
        <Link href={href}>
          <a className="flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:py-2 sm:px-2 lg:px-4 w-12 sm:w-24 lg:w-auto h-12 sm:h-auto lg:h-auto hover:bg-green-50 rounded-full sm:rounded lg:rounded-full">
